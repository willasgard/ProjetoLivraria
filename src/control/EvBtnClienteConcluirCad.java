...
@Override
	public void actionPerformed(ActionEvent e) {
		...
		clt.setCpf(Integer.parseInt(cpf.getText()));
		clt.setRg(Integer.parseInt(rg.getText()));
		...
		clt.setTelefone(Integer.parseInt(telefone.getText()));
		clt.setCelular(Integer.parseInt(celular.getText()));
